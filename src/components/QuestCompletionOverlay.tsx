  ...
  const getRankConfig = () => {
    switch (difficulty) {
      ...
      case QuestDifficulty.B:
        return {
          color: '#f97316',
          bgGradient: 'from-orange-950/20 via-black/95 to-orange-950/20',
          textColor: 'text-orange-500',
          title: 'MISSÃO DE RANK B CONCLUÍDA',
          subtitle: 'EXPERIÊNCIA TRANSFORMADA EM FORÇA',
          icon: <Zap size={60} className="text-orange-400" />,
      ...
      case QuestDifficulty.C:
        return {
          color: '#06b6d4',
          bgGradient: 'from-cyan-950/20 via-black/95 to-cyan-950/20',
          textColor: 'text-cyan-500',
          title: 'MISSÃO DE RANK C CONCLUÍDA',
          subtitle: 'PROGRESSO DO SISTEMA OTIMIZADO',
          icon: <Sword size={50} className="text-cyan-400" />,
          glowColor: 'rgba(6, 182, 212, 0.3)',
          neonClass: 'neon-text-cyan-strong',
          accentHex: '#06b6d4',
          wrapperBg: 'bg-cyan-500/20',
          barBg: 'bg-cyan-400',
          panelBorder: 'border-cyan-500/30',
          headerBorder: 'border-cyan-500/30',
          headerCircle: 'border-cyan-400',
          headerIcon: 'text-cyan-400',
          subtitleText: 'text-cyan-100/80',
          captionText: 'text-cyan-400/60',
          xpIcon: 'text-cyan-400',
          xpLabel: 'text-cyan-600',
        };
      case QuestDifficulty.D:
        return {
          ...
          icon: <ShieldCheck size={45} className="text-cyan-500" />,
