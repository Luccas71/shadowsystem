...
const Store: React.FC<StoreProps> = ({ gold, items, onAddItem, onRemoveItem, onPurchaseItem, isLocked, lockUntil }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 relative">
      ...
      {isAdding && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] border-orange-900/40 transition-all/90 backdrop-blur-md">
          <form onSubmit={handleSubmit} className="system-bg border-2 border-cyan-500/50 rounded-xl w-full max-w-md p-8 space-y-5 shadow-[0_0_50px_rgba(0,229,255,0.2)]">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-black/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] border-orange-900/40 transition-all border border-slate-800 rounded px-4 py-3 text-cyan-100 font-game text-xs focus:border-cyan-500 outline-none transition-all"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-black/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] border-orange-900/40 transition-all border border-slate-800 rounded px-4 py-3 text-slate-300 text-xs focus:border-cyan-500 outline-none h-24 resize-none transition-all"
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-black/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] border-orange-900/40 transition-all border border-slate-800 rounded px-4 py-3 text-cyan-400 font-game text-sm outline-none focus:border-cyan-500"
              />
            </div>
            <div className="flex gap-4 pt-4">
              ...
              <button type="submit" className="flex-1 py-3 font-game text-[10px] bg-cyan-600 text-white rounded shadow-[0_0_15px_rgba(0,229,255,0.4)] uppercase tracking-widest active:scale-95 transition-transform">FORJAR</button>
            </div>
          </form>
        </div>
      )}
