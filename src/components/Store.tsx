    ...
    <div className="space-y-6 animate-in fade-in duration-500 relative">
      <div className="flex justify-between items-center">
        <h2 className={`font-game text-2xl text-sky-400 flex items-center gap-3 uppercase tracking-tighter`}>
          <ShoppingBag className={'text-sky-500'} /> LOJA DO SISTEMA
        </h2>
        <button 
          ...
          <form onSubmit={handleSubmit} className="system-bg border-2 border-sky-500/50 rounded-xl w-full max-w-md p-8 space-y-5 shadow-[0_0_50px_rgba(14,165,233,0.2)]">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full bg-black border border-slate-800 rounded px-4 py-3 text-sky-100 font-game text-xs focus:border-sky-500 outline-none transition-all"
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-black border border-slate-800 rounded px-4 py-3 text-slate-300 text-xs focus:border-sky-500 outline-none h-24 resize-none transition-all"
            ...
            <div>
              ...
              <input 
                ...
                className="w-full bg-black border border-slate-800 rounded px-4 py-3 text-sky-400 font-game text-sm outline-none focus:border-sky-500"
              />
            </div>
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 gap-4`}>
        {items.length === 0 && (
          <div className="col-span-full py-20 flex flex-col items-center opacity-30 border border-dashed border-amber-900/30 rounded-xl">
        ...
        {items.map(item => {
          ...
          return (
            <div 
              ...
              className={`system-bg border rounded-lg p-5 flex flex-col justify-between group cursor-pointer transition-all duration-500 relative overflow-hidden ${
                isLocked 
                ? 'border-slate-800' 
                : isExpanded 
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={`text-[9px] px-1.5 py-0.5 border rounded uppercase font-bold transition-all ${
                    isExpanded ? 'border-amber-400 text-amber-400 bg-amber-400/10' : 'border-amber-900 text-amber-700'
                  }`}>
                ...
                <div className={`relative transition-all duration-500 ${isExpanded ? 'max-h-[500px] mb-4' : 'max-h-12 mb-3'}`}>
                  ...
                  {isExpanded && (
                    <div className="mt-4 pt-4 border-t border-amber-900/30 animate-in fade-in slide-in-from-top-2">
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <div className="flex items-center gap-2" onClick={e => e.stopPropagation()}>
                    ...
                    <button 
                      ...
                      className={`px-5 py-2 rounded font-game text-[10px] uppercase tracking-widest transition-all active:scale-95 ${
                        gold >= item.cost 
