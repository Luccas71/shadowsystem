        ...
        return (
          ...
          >
            <motion.div
              ...
              className="relative p-1 bg-sky-500/20 rounded-sm overflow-hidden min-w-[350px] max-w-md"
            >
              <div className="absolute top-0 left-0 right-0 h-1 bg-sky-400 shadow-[0_0_15px_#38bdf8]" />
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-sky-400 shadow-[0_0_15px_#38bdf8]" />
              <div className="system-panel p-8 bg-slate-950/95 flex flex-col items-center gap-6 text-center">
                <div className="p-4 border-2 border-sky-400 rounded-full bg-sky-950/30">
                  {activeEffect.icon || <Zap size={48} className="text-sky-400" />}
                </div>
                <div className="space-y-2">
                  <h2 className="font-game text-xs text-sky-500 tracking-[0.4em] uppercase font-bold">ITEM CONSUMIDO</h2>
                ...
                {activeEffect.subtitle && (
                  <div className="w-full h-px bg-sky-900/30 my-2" />
                )}
                {activeEffect.subtitle && (
                  <p className="font-game text-[11px] text-sky-300/80 tracking-widest leading-relaxed uppercase italic">
                    {activeEffect.subtitle}
                  </p>
                )}
              </div>
        ...
        return (
          ...
          >
            <motion.div
              ...
              className="relative p-1 bg-sky-500/20 rounded-sm overflow-hidden min-w-[300px]"
            >
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-sky-400 shadow-[0_0_10px_#38bdf8]" />
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-sky-400 shadow-[0_0_10px_#38bdf8]" />
