...
const QuestCard: React.FC<QuestCardProps> = ({
  ...
  const colorMap: Record<string, {
    ...
    slate: {
      badge: 'text-slate-400 border-slate-500/30 bg-black/40',
      badgeFailed: 'text-rose-500/80 border-rose-500/30 bg-rose-950/40',
      subHeader: 'text-slate-500',
      subBorder: 'border-slate-800/30',
      subCheckActive: 'bg-slate-600 border-slate-500 text-white',
      inputBorder: 'border-slate-800/40 text-slate-100 focus:border-slate-500',
      addBtnClasses: 'bg-slate-900/40 border-slate-800 text-slate-500 hover:bg-slate-600 hover:text-white',
      flameIcon: 'text-slate-500',
    },
    green: {
      badge: 'text-emerald-400 border-emerald-500/30 bg-black/40',
      badgeFailed: 'text-rose-500/80 border-rose-500/30 bg-rose-950/40',
      subHeader: 'text-emerald-500',
      subBorder: 'border-emerald-800/30',
      subCheckActive: 'bg-emerald-600 border-emerald-500 text-white',
      inputBorder: 'border-emerald-800/40 text-emerald-100 focus:border-emerald-500',
      addBtnClasses: 'bg-emerald-900/40 border-emerald-800 text-emerald-500 hover:bg-emerald-600 hover:text-white',
      flameIcon: 'text-emerald-500',
    },
    blue: {
      badge: 'text-sky-400 border-sky-500/30 bg-black/40 shadow-[0_0_8px_rgba(56,189,248,0.15)]',
      badgeFailed: 'text-rose-500/80 border-rose-500/30 bg-rose-950/40',
      subHeader: 'text-sky-500',
      subBorder: 'border-sky-800/30',
      subCheckActive: 'bg-sky-600 border-sky-500 text-white shadow-[0_0_5px_rgba(56,189,248,0.3)]',
      inputBorder: 'border-sky-800/40 text-sky-100 focus:border-sky-500',
      addBtnClasses: 'bg-sky-900/40 border-sky-800 text-sky-500 hover:bg-sky-600 hover:text-white',
      flameIcon: 'text-sky-500',
    },
    purple: {
      badge: 'text-violet-400 border-violet-500/30 bg-black/40 shadow-[0_0_8px_rgba(139,92,246,0.15)]',
      badgeFailed: 'text-rose-500/80 border-rose-500/30 bg-rose-950/40',
      subHeader: 'text-violet-500',
      subBorder: 'border-violet-800/30',
      subCheckActive: 'bg-violet-600 border-violet-500 text-white shadow-[0_0_5px_rgba(139,92,246,0.3)]',
      inputBorder: 'border-violet-800/40 text-violet-100 focus:border-violet-500',
      addBtnClasses: 'bg-violet-900/40 border-violet-800 text-violet-500 hover:bg-violet-600 hover:text-white',
      flameIcon: 'text-violet-500',
    },
    orange: {
      badge: 'text-orange-400 border-orange-500/30 bg-black/40 shadow-[0_0_8px_rgba(249,115,22,0.15)]',
      badgeFailed: 'text-rose-500/80 border-rose-500/30 bg-rose-950/40',
      subHeader: 'text-orange-500',
      subBorder: 'border-orange-800/30',
      subCheckActive: 'bg-orange-600 border-orange-500 text-white shadow-[0_0_5px_rgba(249,115,22,0.3)]',
      inputBorder: 'border-orange-800/40 text-orange-100 focus:border-orange-500',
      addBtnClasses: 'bg-orange-900/40 border-orange-800 text-orange-500 hover:bg-orange-600 hover:text-white',
      flameIcon: 'text-orange-500',
    },
    red: {
      badge: 'text-rose-400 border-rose-500/30 bg-black/40 shadow-[0_0_8px_rgba(244,63,94,0.15)]',
      badgeFailed: 'text-rose-400 border-rose-500/30 bg-black/40',
      subHeader: 'text-rose-500',
      subBorder: 'border-rose-800/30',
      subCheckActive: 'bg-rose-600 border-rose-500 text-white shadow-[0_0_5px_rgba(244,63,94,0.3)]',
      inputBorder: 'border-rose-800/40 text-rose-100 focus:border-rose-500',
      addBtnClasses: 'bg-slate-900/40 border-slate-800 text-rose-500 hover:bg-rose-600 hover:text-white',
      flameIcon: 'text-rose-500',
    },
  };
